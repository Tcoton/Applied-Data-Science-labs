...
site_options = [{'label': 'Launch Site', 'value': 'ALL'}]
...
def get_scatter_chart(site, payload):
    if site == 'ALL':
        ...
        figure = px.scatter(df, x='Payload Mass (kg)', y='class', color='Booster Version Category', labels={ "class": "Fail (0) / Success (1)"}, title="Correlation Payload/Success")
        return figure
    else:
